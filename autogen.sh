...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_aym to login script."
...
# the current dir:
if   test x${GTLANG_aym} = x ; then
	echo "WARNING: The variable \${GTLANG_aym} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_aym} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_aym} has the value:"
	echo "  ${GTLANG_aym}"
