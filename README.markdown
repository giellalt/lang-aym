...
This directory contains source files for the Aymara language morphology
...
-   <https://giellalt.uit.no/lang/aym/index.html> (analyser)
-   <https://giellalt.uit.no/index.html> (infrastructure)

Requirements
------------

In order to compile and use Aymara language morphology and dictionaries,
you need:
...
The Aymara language sources can be acquired using [giella SVN
